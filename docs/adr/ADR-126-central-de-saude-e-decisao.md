...
- **Status:** Implementada (Fatias 1–3). F1 status determinístico + top-3 prioridades; F2 aplicar → Impact Ledger unificado (ADR-125) + histórico; F3 modo Tutor/Gestor (com "como fazer" por prioridade), narrativa determinística do Diretor e checklist de qualidade dos dados. Próximos ADRs consomem esta base: Índice de Sobrevivência 0-100, DRE gerencial, Empresa × Proprietário.
- **Data:** 2026-07
