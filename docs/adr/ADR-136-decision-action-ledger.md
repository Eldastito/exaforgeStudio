...
- **Status:** Epic 2 / Fatias C1 (Ledger de Sinais), C2a (Ações + Aprovações + Políticas de autonomia) e C2b (Outcomes / Impact Ledger unificado) implementadas. Pareto (C3), UI (C4) e o executor governado (C5) nas fatias seguintes.
- **Data:** 2026-07
...
## Consequências
**Positivas:** cria o contrato único de sinais, o ciclo de ação governado (propor→aprovar→concluir) **e** o Impact Ledger unificado (esperado×realizado, fato≠estimativa) sobre o qual o Pareto (C3) prioriza; reusa os motores existentes; idempotente e auditável. Aditivo — nada dos fluxos atuais muda.
