...
- **Status:** Epic 0 / Fatia 1 (gate financeiro opt-in + testes de negação) implementada. Ocultar no menu o que o perfil não acessa (front) e reduzir os erros de typecheck legados vêm nas fatias seguintes.
- **Data:** 2026-07
...
## Consequências
**Positivas:** finanças passam a ter proteção RBAC explícita, ativável **sem risco** para o parque legado (opt-in por org). Reusa toda a fundação da ADR-095. Auditável. Cumpre a condição do PRD de "acesso financeiro explicitamente protegido" antes de ampliar autonomia de IA sobre finanças.
