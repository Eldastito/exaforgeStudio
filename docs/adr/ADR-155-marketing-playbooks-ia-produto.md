...
- **Status:** EM PROGRESSO — Fase 1 redesenhada com o padrão grimoire (padrão 4 do `docs/patterns/agentic-pipeline-lessons.md`). **F1.1 implementada** (esqueleto `docs/grimoire/copy/` + 4 rubricas-núcleo + validador estrutural `test:grimoire-copy`). Próxima: **F1.2** (`GrimoireService` — loader + roteamento just-in-time). Demais fases aguardam priorização do dono da plataforma.
- **Data:** 2026-08-08
