...
> **Não abrir** roteamento/RAG antes de tarefas+eventos+listas estáveis em produção — a convergência avança por domínio, medindo regressão a cada passo.
...
| F8+ | D5 — porta I/O: roteamento WhatsApp p/ choke-point, dedup de RAG | planejada |
