...
**Estado:** Em implementação — **F0 + F1 + F2(processo/runtime) FECHADAS; fatia HOST/INFRA da F2 (disco/rede/swap/limites de container) bloqueada por dados de AMBIENTE do operador**
