...
**Estado:** Em implementação — **F0 + F1 + F2(processo/runtime) + F3(SLI HTTP) FECHADAS; fatia HOST/INFRA da F2, o SLO por jornada (F3.4) e a F4+ dependem de dados de AMBIENTE / baseline real**
