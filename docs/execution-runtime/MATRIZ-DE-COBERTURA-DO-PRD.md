...
| Cadência executada pelo Runtime | [~] MVP + F4b.2: 1 lembrete + intent router | F4b (F4b.3 pra 2ª/3ª tentativa) | F4b: playbook `receivable_collection_v1` de 1 step. F4b.2: `CollectionReplyService.tryHandle` intercepta resposta antes da IA e sinaliza. Cadência multi-tentativa (2ª/3ª lembrança + aviso de negativação) fica em F4b.3 |
