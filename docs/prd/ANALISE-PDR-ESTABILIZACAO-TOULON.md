...
- **Fase 2 (P1)** — 2A diretório + lotação + descoberta por filial ✅ · 2B UI "Vendedores da loja" (cobertura + dar-nome + lotação) ✅ · 2C escala por loja + comissão com fonte/pendência · cota total única.
