...
- **Fase 5 (P2) — em andamento** — 5A probe leve e autenticado `GET /api/health/ping` (`HealthProbeService`, CONN-003) ✅ · 5B modelo de 4 estados + texto honesto + polling do probe na UI (CONN-001/002) · 5C diagnóstico expandido no chip (CONN-004) · 5D salvamento em degradação (CONN-005).
