...
| F3 | F3.1–F3.4 | **EM ANDAMENTO** | F3.0 auditoria + F3.1a Diretor (`executive-money-projection` 24/24) + F3.1b fachada de identidade (`sender-identity` 30/30) | G3 (CA-04/05/06) — próximo: F3.2 prova de posse |
