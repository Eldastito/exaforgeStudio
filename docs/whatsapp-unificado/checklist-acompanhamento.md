...
| F2 | F2.1–F2.4 | **EM ANDAMENTO** | F2.1 (a+b) + F2.2 (resolvedor + controles de escrita, `channel-binding` 21/21) | G2 (falta F2.2 UI · F2.3 · F2.4) |
