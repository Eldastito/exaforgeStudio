...
| F3 | F3.1–F3.4 | **EM ANDAMENTO** | F3.0 + F3.1a (`executive-money-projection` 24/24) + F3.1b (`sender-identity` 30/30) + F3.2 (`phone-possession` 20/20) + F3.3a roteador puro (`mixed-mode-router` 22/22) | G3 (CA-04/05/06) — próximo: F3.3b fiação do roteador atrás de flag |
