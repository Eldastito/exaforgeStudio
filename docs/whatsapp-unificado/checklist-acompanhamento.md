...
| F3 | F3.1–F3.4 | **EM ANDAMENTO** | F3.0 + F3.1a (24/24) + F3.1b (30/30) + F3.2 (20/20) + F3.3a (`mixed-mode-router` 22/22) + F3.3b fiação atrás de flag (`mixed-mode-inbound` 12/12) | G3 (CA-04/05/06) — próximo: F3.4 confirmação durável (CA-06) |
