...
const SEED: SeedItem[] = [
  ...
  },
  {
    ...
    domain: "growth",
    priority: "P1",
    summary: "vertical_intelligence GLOBAL + CompetitiveIntelligenceProvider stub. Rota via decisionIntelligence.",
    source_of_truth: "ADR-156",
    target_status: "CODED",
    blocked_reason: "Provider competitivo stub sem rede/db real. Contrato de fonte externa faltando.",
    sources: [
  ...
  },
  {
    ...
    domain: "studio",
    priority: "P0",
    summary: "Comandos /ProductExplosion, /3Dbillboard, /MagazineCover, /AddCreative, /3DSoft, /LifestyleShort — não existem como capacidades nomeadas. Infra base (StudioService, llm.ts Imagen/Veo) EXISTE para reuso.",
    target_status: "PRD_READY",
    blocked_reason: "Sem ADR nem PRD dedicado — precisa escrever antes da Fase 6 do PRD-PEL-01",
    sources: [
      { source_type: "prd", title: "PRD-PEL-01 §12 Closure Track A (Visual Recipe Engine)", notes: "Não está checked-in no repo" },
    ],
  },
  {
    ...
    domain: "platform",
    priority: "P1",
    summary: "PRD-BSP-01 NÃO está checked-in no repo. Sub-capacidades espalhadas em ComigoPricing/RetailPricing/pricing.ts/QuoteService. Local Marketing praticamente ausente.",
    target_status: "IDEA",
    blocked_reason: "PRD-BSP-01 fora do repo; decisão pendente entre importar ou reescrever consolidando serviços verticais",
    sources: [
      { source_type: "prd", title: "PRD-PEL-01 §14 Closure Track C (Business Skills Pack)", notes: "Referencia PRD-BSP-01 como fonte autoritativa, mas ele não está no repo" },
      { source_type: "file", title: "src/server/pricing.ts (markup Loja Virtual)", source_reference: "src/server/pricing.ts" },
    ],
  },
  {
