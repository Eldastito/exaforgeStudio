...
const STUB_ITEMS: ReputationItem[] = [
  {
    ...
    author: "Maria Silva", rating: 1, ratingScale: 5, sentiment: "negative",
  ...
  },
  {
    ...
    author: "João Pereira", rating: 2, ratingScale: 5, sentiment: "negative",
  ...
  },
  {
    ...
    author: "Ana Paula Lima", rating: 4, ratingScale: 5, sentiment: "positive",
