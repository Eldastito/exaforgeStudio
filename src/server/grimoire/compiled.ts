...
export const GRIMOIRE_INDEX = {
  ...
  "modulos": {
    ...
    "referrals": {
      "intake": [
        "intake/referral-timing.md"
      ],
      "compose": [
        "compose/referral-ask.md"
      ],
      "guardrails": [
        "guardrails/lgpd-e-whatsapp.md"
      ],
